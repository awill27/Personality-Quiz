...
enum AnimalType: Character {
    ...
    var definition: String {
        switch  self{
        case .fish:
            return "Fish - Pisces♓️ You are very sociable and a leader. You tend to supress your feelings. When stressed you will hide. Very intelligent. Capable of emotions: fear, joy, and playfulness. Sometimes eager or bold. Observing and can recognize when being watched and will alter your behavior accordingly. You are also a dreamer, mysterious, imaginative, and idealistic. You adapt to any situation. On the other hand you can be overly trusting and always fighting for the underdog."
        case .lion:
        ...
        case .ram:
            return "Ram - Aries♈️ You are very strong and persistent. Also, easy going until agitated. A confrontation about territory; decides, who will be the dominating one. You love warm temperatures and you command leadership and authority. You strive for power and you are very brave. You are determined and get easily frustrated. Also, you have the characteristics of a fearless warrior wanting to command their army. You are bold and impulsive, yet aggressive"
        }
